...
const file_transaction_proto_rawDesc = "" +
	...
	"\x05state\x18\x02 \x01(\tR\x05state2\x9b\x01\n" +
	"\x16TransactionCoordinator\x12>\n" +
	"\vSubmitOrder\x12\x16.pb.SubmitOrderRequest\x1a\x17.pb.SubmitOrderResponse\x12A\n" +
	"\x0eGetOrderStatus\x12\x16.pb.OrderStatusRequest\x1a\x17.pb.OrderStatusResponse2\xdf\x01\n" +
...
var file_transaction_proto_depIdxs = []int32{
	...
	13, // 8: pb.TransactionParticipant.GetStatus:input_type -> pb.StatusRequest
	1,  // 9: pb.TransactionCoordinator.SubmitOrder:output_type -> pb.SubmitOrderResponse
	3,  // 10: pb.TransactionCoordinator.GetOrderStatus:output_type -> pb.OrderStatusResponse
	5,  // 11: pb.TransactionParticipant.Prepare:output_type -> pb.PrepareResponse
	10, // 12: pb.TransactionParticipant.Commit:output_type -> pb.CommitResponse
	12, // 13: pb.TransactionParticipant.Abort:output_type -> pb.AbortResponse
	14, // 14: pb.TransactionParticipant.GetStatus:output_type -> pb.StatusResponse
